...
#ワークシートを事前にクリアする
wb = openpyxl.load_workbook(r'C:\Users\hishi\OneDrive\Workplace\2026年営業計画\wk_nouhin.xlsx')
wb.remove(wb.worksheets[-1])
ws = wb.create_sheet(title="Sheet1")
wb.save(r'C:\Users\hishi\OneDrive\Workplace\2026年営業計画\wk_nouhin.xlsx')
...
con_str1 = (
	...
	r'DBQ=C:\Users\hishi\OneDrive\Workplace\2026年営業計画\納品データ\納品書Ver.1.2元データ用(2025版 税率10% 西暦表示).mdb;'
	)
...
sql1 = 'SELECT * FROM 納品書 \
        ...
        WHERE 納品日 Between #2026/01/01# AND #2026/01/31#'
